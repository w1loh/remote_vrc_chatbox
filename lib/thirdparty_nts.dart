    ...
    LicenseRegistry.addLicense(() {
      return Stream<LicenseEntry>.fromIterable(<LicenseEntry>[
        const LicenseEntryWithLineBreaks(
            <String>["Alte DIN 1451 Mittelschrift"], '''
Copyright (c) 2017, Peter Wiegel, www.peter-wiegel.de, wiegel@peter-wiegel.de
with Reserved Font Name "Alte DIN 1451"
...
OTHER DEALINGS IN THE FONT SOFTWARE.
            '''),
        const LicenseEntryWithLineBreaks(<String>["Noto Sans Japanese"], '''
...
OTHER DEALINGS IN THE FONT SOFTWARE.
            '''),
        const LicenseEntryWithLineBreaks(
            <String>["Font Awesome Icons Free"], '''
CC BY 4.0 © Fonticons, Inc.
...
//             '''),
        ...
        const LicenseEntryWithLineBreaks(
            <String>["Google翻訳 - Cloud Translation API"], '''
このサービスには、Google により提供される翻訳が含まれる場合があります。Google は、明示的か黙示的かを問わず、翻訳に関するすべての保証（精度、信頼性に関するあらゆる保証、および商品性、特定目的への適合性、第三者の権利の非侵害性に関するあらゆる黙示的保証を含みます）を放棄します。
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: const Text("remote vrc-chatbox",
